...
export const DEFAULT = {
  profile: {
    ...
    background: "solid",     // 배경 스타일: solid|gradient|dots|grid
...
export function clean(data) {
  ...
  return {
    profile: {
      ...
      background: ["solid", "gradient", "dots", "grid"].includes(pf.background) ? pf.background : "solid",
...
export async function provisionSite(handle, opts = {}) {
  ...
  return { ok: true, handle, key, created: !existing, url: "/?u=" + handle };
}
