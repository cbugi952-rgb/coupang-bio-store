...
// 채널 정보로 사이트 데이터 생성. OPENAI_API_KEY 또는 ANTHROPIC_API_KEY 필요(lib/ai.js가 고름).
export async function generateSiteFromChannel(channel) {
  const site = await completeJSON({
    system: SYSTEM_PROMPT,
    user: buildChannelBrief(channel),
    schema: SITE_SCHEMA,
    schemaName: "onshelf_site",
